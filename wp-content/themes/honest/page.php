			...
			<div class="row">
				<div class="span4">
					<div class="box-photo">
						...
						<div class="content-wrap">
							<h4 class="text-uppercase text-red text-center">Indoor Cycling</h4>
				...
				<div class="span4">
					<div class="box-photo">
						...
						<div class="content-wrap">
							<h4 class="text-uppercase text-red text-center">Circuit Training</h4>
							<p class="small">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ac varius quam, at ullamcorper dolor. Integer fermentum, nulla quis commodo lacinia, est arcu efficitur eros, ac iaculis lectus lectus vel augue. Sed sed diam massa. </p>
						</div>
					</div>
				</div>
				<div class="span4">
					<div class="box-photo">
						...
						<div class="content-wrap">
							<h4 class="text-uppercase text-red text-center">Yoga</h4>
							<p class="small">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ac varius quam, at ullamcorper dolor. Integer fermentum, nulla quis commodo lacinia, est arcu efficitur eros, ac iaculis lectus lectus vel augue. Sed sed diam massa. </p>
						</div>
					</div>
				</div>
